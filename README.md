...
## Execution
After preparing the host and cloning the repository, run `docker compose up` in the project root to instantiate the runtime environment. Running `python app/main.py` will perform the trial runs.
